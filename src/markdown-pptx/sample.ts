...
import { createMasterSlides } from "./masters";

execGenSlidesFuncs();

export async function execGenSlidesFuncs() {
...
export function genSlidesText(pptx: PptxGenJS) {
  // pptx.addSection({ title: "Masters" });
  // genMaterSlide01(pptx);
  // genMaterSlide02(pptx);
...
// function genImage(pptx:PptxGenJS) {
...
function genMaterSlide01(pptx: PptxGenJS) {
...
function genMaterSlide02(pptx: PptxGenJS) {
	let slide = pptx.addSlide({ masterName: "MASTER_SLIDE", sectionTitle: "Masters" });
	slide.addText("Title Text Placeholder", { placeholder: "title" });
	slide.addText(
		[
      { text: "Section", options: { fontSize: 36 } },
...
function genSlide00(pptx: PptxGenJS) {
  let slide = pptx.addSlide({ sectionTitle: "Text" });

  slide.addText(
    [
      {
        text: "options: header1 style: arabicPeriod",
        options: header1
      },
      {
        text: "style: arabicPeriod",
        options: {
          color: pptx.SchemeColor.accent2,
...
function genSlide01(pptx: PptxGenJS) {
  ...
  let objOptions: PptxGenJS.TextPropsOptions = {
    x: 0,
    y: 7,
    w: "100%",
    h: 0.5,
...
function genSlide02(pptx: PptxGenJS) {
  ...
  slide.addTable(
    [
      [
        ...
        BASE_TEXT_OPTS_R as PptxGenJS.TextProps,
      ],
    ],
    BASE_TABLE_OPTS
  );
  ...
  slide.addText(
    ...
    ],
    {
      ...
      h: 6.0,
      margin: 5,
      fill: { color: pptx.SchemeColor.text1 },
    }
  );
...
function genSlide03(pptx: PptxGenJS) {
  ...
  slide.addText(
    [
      ...
      {
        text: "Mix and... ",
        options: { fontSize: 24, color: "FF0000", bullet: { code: "25BA" } },
      },
      {
...
function genSlide04(pptx: PptxGenJS) {
    ...
    [
      {
        ...
        options: {
          tabStops: [{ position: 1 }, { position: 3 }, { position: 7 }],
        },
      },
    ],
    {
  ...
  slide.addText("type:outer, offset:10, blur:3", {
    ...
    fontSize: 32,
    color: "0088cc",
    shadow: shadowOpts as PptxGenJS.ShadowProps,
  });
}
...
function genSlide06(pptx: PptxGenJS) {
  ...
  slide.addTable(
    [
      [
        { text: "Text Examples: Scheme Colors", options: BASE_TEXT_OPTS_L },
        BASE_TEXT_OPTS_R,
      ],
    ],
    BASE_TABLE_OPTS
  ...
  slide.addText("ACCENT2", {
    ...
    h: 1.0,
    color: "FFFFFF",
    fill: { color: pptx.SchemeColor.accent2 },
  });
  ...
  slide.addText("ACCENT6", {
    ...
    h: 1.0,
    color: "FFFFFF",
    fill: { color: pptx.SchemeColor.accent6 },
  });
